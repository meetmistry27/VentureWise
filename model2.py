...
#         response_data = {
#             'status': 'success',
#             'startup_name': input_data.get('name', 'New Startup'),
...
# #     # 🔥 ADD THESE LINES: save models to pickle files
...
# #     with open('market_share_model.pkl', 'wb') as f:
# #         pickle.dump(market_share_model, f)
    
# #     print("Models saved as pickle files: revenue_model.pkl, valuation_model.pkl, market_share_model.pkl")
